...
/* USER CODE BEGIN PV */
 int flag = 0;
 bool flag_int = false;
 bool flag_int_servo_control = false;
 bool flag_int_motor_control = false;
...
/*--------------------------------------------- MOTOR ACTUATION AND CONTROL ---------------------------------------------*/
	  	  	  	  ...
	  	  	  	  if(flag_int_motor_control == true){
	  	  	  		  ...
	  	  	  		  sprintf(msg_VL53L1X, "%d,%d",rangingData.RangeMilliMeter, ing_motors);
...
/*--------------------------------------------- SERVO-MOTOR ACTUATION AND CONTROL ---------------------------------------------*/
	  	  	  	  ...
	  	  	  	  if(flag_int_servo_control == true){
	  	  	  		  ...
	  	  	  		  sprintf(msg_bno, "%ld,%ld,%d,%d", axis_rotation_ist->rot_x, axis_rotation_ist->rot_y, ing_roll, ing_pitch);
	  	  	  		  HAL_UART_Transmit(&huart3, (uint8_t*)msg_bno, strlen(msg_bno), HAL_MAX_DELAY);
...
static void MX_TIM13_Init(void)
{
  ...
  htim13.Init.Prescaler = 4999;
  htim13.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim13.Init.Period = 749;

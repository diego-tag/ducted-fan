...
\begin{document}
	...
	Il \textit{DPDF} presenta una struttura cilindrica cava di 220 [mm] di altezza e con un diametro esterno pari a 235 [mm]. Il diametro interno, pari a 230 [mm], contiene le componenti necessarie al volo stabile dell'UAV.
	...
	Al fine di limitare tali perturbazioni, la parte inferiore del \textit{DPDF} integra due \textit{flap}: uno dedicato al controllo dell'assetto lungo l'asse delle ascisse e uno lungo l'asse delle ordinate.
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			\centering
			\includegraphics[height=5.5cm,keepaspectratio]{figures/001_sistema/struttura_ducted_fan_1.jpg}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.48\textwidth}
			\centering
			\includegraphics[height=5.5cm,keepaspectratio]{figures/001_sistema/struttura_ducted_fan_2.jpg}
		\end{subfigure}
		\caption{\textcolor{black}{Struttura ducted fan}}
		\label{fig:struttura_ducted_fan}
	\end{figure}
	
	\section{Controllo del Double Propeller Ducted-Fan}
	L'attuale obiettivo di controllo prevede l'ottenimento dell'\textit{hovering} del \textit{DPDF}.
	Con il termine \textit{hovering} si fa riferimento alla condizione di volo stazionario, in cui l'UAV rimane fermo nello spazio rispetto a un riferimento inerziale, mantenendo posizione e quota costanti nel tempo.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\textwidth]{figures/01_hardware/architettura_stm32h745zi_tq6.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/nucleo_h745zi_q_dettaglio_jumper.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/nucleo_h745zi_q_vista_superiore.png}
	...
	\begin{figure}[ht]
		...
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/batteria_tattu_lipo_4s_1300mah_75c.jpg}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/modulo_powersafe_twin_adv.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.5\textwidth]{figures/01_hardware/convertitore_tensione_dfrobot_terminali_uscita.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/convertitore_tensione_dfrobot_foto_reale.jpg}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/scheda_distribuzione_potenza_quad.jpg}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\textwidth]{figures/01_hardware/motore_turnigy_aerodrive_sk3_3536_1400kv.jpg}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/esc_turnigy_plush_40a.jpg}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/schema_collegamenti_programmazione_esc.png}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/scheda_programmazione_turnigy.jpg}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.55\textwidth]{figures/01_hardware/elica_apc_9x4_5.png}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.4\textwidth]{figures/01_hardware/servo_hs_82mg_caratteristiche_fisiche.jpg}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/servo_hs_82mg_foto.jpg}
		\caption{HS-82 MG}
		\label{fig:hs82-foto}
	\end{figure}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.7\textwidth]{figures/01_hardware/servo_hs_82mg_collegamenti_elettrici.png}
	...
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=0.4\textwidth]{figures/01_hardware/bno055_pinout_superiore.jpg}
	...
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=0.4\textwidth]{figures/01_hardware/bno055_architettura_sistema.png}
	...
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=1.0\textwidth]{figures/01_hardware/bno055_frequenza_aggiornamento.png}
	...
	\begin{figure}[ht]
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth]{figures/01_hardware/vl53l1x_modulo_pololu_configurazione_pin.jpg}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth]{figures/01_hardware/vl53l1x_schema_blocchi_sistema.png}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/01_hardware/vl53l1x_dettaglio_emettitore.png}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.7\textwidth]{figures/01_hardware/vl53l1x_cono_campo_visivo.jpg}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.7\textwidth]{figures/01_hardware/vl53l1x_prestazioni_timing_budget.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth,keepaspectratio]{figures/01_hardware/schema_collegamenti_ducted_fan.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth,keepaspectratio]{figures/02_software/diagramma_flusso_software.jpg}
		\caption{Diagramma di flusso del codice sviluppato}
		\label{fig:diagramma}
	\end{figure}
	
	\section{Gestione singoli componenti}
	Dedicare un paragrafo ad ogni componente in cui viene spiegato il codice che lo gestisce. Inserite prima una descrizione generale di come si gestisce un componente di quel tipo (aiutandovi con schemi o altro). Poi le configurazioni che sono state fatte sul .ioc per poterlo utilizzare (quali periferiche sono state abilitate, come sono state configurate.. mettete degli screen del .ioc). Infine inserite e spiegate le parti di codice che lo gestiscono.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth,keepaspectratio]{figures/03_test_risultati/grafico_risultati_test.jpg}
